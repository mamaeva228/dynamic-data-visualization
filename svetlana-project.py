from PySide2 import QtWidgets#выводятся автоматически подсказки если импортируем весь модуль
...
class Table(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        print("gopnik1")
        df = pd.read_csv('C:/Users/Sony/Downloads/all_hour.csv')
...
class MyWindow(QtWidgets.QWidget):
    ...
    def Add_S(self):                                                         #номер графика
        my_sheet=Sheet("C:/Users/Sony/Downloads/all_hour.csv", len(self.arr_sheet)+1) #наверное тк нет метода show()+скрин что надо деалать чтобы окно рисовалось
